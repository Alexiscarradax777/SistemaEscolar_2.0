                                ...
                                <tbody>
                                    ...
                                    foreach ($materias as $materia) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?= $materia['nombre_carrera']; ?></td>
                                            <td style="text-align: center"><?= $materia['nombre_cuatrimestre']; ?></td>
                                            <td style="text-align: center"><?= $materia['nombre_materia']; ?></td>
                                            <td style="text-align: center"><?php
                                                                            if ($materia['estado'] == '1') print "ACTIVO";
                                                                            else
                                                                                print "NEGATIVO";
                                                                            ?>
                                            </td>
    ...
    $(function() {
        $("#example1").DataTable({
            ...
            "language": {
                ...
                "infoEmpty": "Mostrando 0 to 0 of 0 Materias",
