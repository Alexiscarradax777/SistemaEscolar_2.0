...
include('../../app/controllers/usuarios/datos_del_usuario.php'); // incluye los datos del Usuario
                                            ...
                                            <div class="form-inline">
                                                <select name="rol_id" id="" class="form-control">
                                                    ...
                                                    <?php foreach ($roles as $role) {
                                                        $nombre_rol_table = $role['nombre_rol']; ?>
                                                        <option value="<?= $role['id_rol']; ?>" <?php if ($nombre_rol == $nombre_rol_table) { ?>selected="selected" <?php } ?>>
                                                            <?= $role['nombre_rol']; ?>
                                                        </option>
