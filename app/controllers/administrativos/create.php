...
////////// Hacemos la consulta para insertar la tabla Administrativos
...
if ($sentencia->execute()) {
    ...
    $pdo->commit();
    session_start();
    $_SESSION['mensaje'] = "Se regitro el Administrativo correctamente";
    ...
    $pdo->rollBack();
    session_start();
    $_SESSION['mensaje'] = "Error no se pudo registrar el Administrativo";
